...
/*   Updated: 2021/02/26 01:18:40 by tel-bara      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static t_gnl_list	*find_lst(int fd, t_gnl_list **lst)
{
	t_gnl_list			*new;
	t_gnl_list			*cycle;
...
static char	*copy_till_newline(t_gnl_list *lst)
{
	char					*tmp;
	ssize_t					start;
	ssize_t					i;
...
static int	exit_get_next_line(t_gnl_list **lst, t_gnl_list *curr,
int rtn_value)
{
	t_gnl_list			*tmp;
	t_gnl_list			*cycle;
...
static int	process_input(t_gnl_list **lst, t_gnl_list *curr,
char **line)
{
	char				*tmp;
